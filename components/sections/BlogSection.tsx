...
const POSTS = [
  { date: "February 6, 2026",  title: "Using Whitespace as Luxury",   slug: "using-whitespace-as-luxury",  category: "Design",      hue: "210" },
  { date: "February 3, 2026",  title: "Core Web Vitals",              slug: "core-web-vitals",             category: "SEO",         hue: "150" },
  { date: "February 1, 2026",  title: "The Framer Advantage",         slug: "the-framer-advantage",        category: "Development", hue: "260" },
  { date: "January 28, 2026",  title: 'The Secret to "Delight"',      slug: "the-secret-to-delight",       category: "UX",          hue: "30"  },
];
  ...
  return (
    <section ref={ref} className="w-full bg-black section-padding">
      <div className="w-full max-w-[1200px] mx-auto flex flex-col gap-20">
        ...
        {/* Grid — 4 columns, each card 400px wide (Framer exact), landscape image */}
          ...
          {POSTS.map((post, i) => (
            ...
            >
              <Link href={`/blog/${post.slug}`} className="group flex flex-col gap-[10px]">
                ...
                {/* Image — 1.6:1 landscape (Framer exact aspect-ratio) */}
                <div
                  className="w-full rounded-[15px] overflow-hidden relative"
                  style={{ aspectRatio: "1.6", background: `linear-gradient(135deg, hsl(${post.hue}, 20%, 10%) 0%, hsl(${post.hue}, 12%, 6%) 100%)` }}
                >
                  <div
                    className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                    style={{ background: `radial-gradient(ellipse at 50% 100%, hsl(${post.hue}, 35%, 16%) 0%, transparent 70%)` }}
                  />
                  <span
