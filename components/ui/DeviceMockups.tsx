...
/* ─── MacBook ─────────────────────────────────────────────────────────────── */
function LaptopMockup({ url }: { url: string }) {
...
/* ─── Section ─────────────────────────────────────────────────────────────── */
export default function DeviceMockups({ url, title }: { url: string; title: string }) {
  return (
    <section style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", gap: 24 }}>
      ...
      <p style={{ fontSize: 11, color: "rgba(255,255,255,0.18)", letterSpacing: "0.02em" }}>
        Live embed · {title} · some sites may restrict iframe display
      </p>
    </section>
  );
}
